...
const BlindUserPage = () => {
  ...
  const fetchWeatherForCurrentDay = () => {
    fetchWeatherData(city, false, setWeather, setLoading);
  };

  const fetchWeatherForTomorrow = () => {
    fetchWeatherData(city, true, setWeather, setLoading);
  };

  return (
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.topContainer}>
        <WeatherInput city={city} setCity={setCity} fetchWeatherData={(city) => fetchWeatherData(city, showTomorrow, setWeather, setLoading)} loading={loading} />
        <View style={styles.buttonContainer}>
          <TouchableOpacity 
            style={styles.button}
            onPress={fetchWeatherForCurrentDay} 
          ...
          <TouchableOpacity 
            style={styles.button}
           onPress={() => speakWeather(weather, showTomorrow)}
            disabled={!city || loading}
          >
